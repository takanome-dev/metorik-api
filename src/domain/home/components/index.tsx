            ...
            <div className="mx-auto max-w-7xl lg:grid lg:grid-cols-12 lg:gap-x-8 lg:px-8">
                <div className="px-6 pt-10 pb-24 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
                    <div className="max-w-2xl mx-auto lg:mx-0">
                        <Image className="w-24 h-24" width={500} height={500} src="/logo.png" alt="METORIK" />
                        ...
                        <h1 className="mt-24 text-4xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">
                            Unlock the Power of API Analytics with <span className="text-pink-400">Metorik</span>
                        </h1>
                        <p className="mt-6 text-lg leading-8 text-gray-600">
                            Uncover Actionable Insights, Track Key Metrics, and Optimize Your API Performance with
                            Metorik — The Comprehensive Analytics Solution Built for Developers and Small Businesses.
                        </p>
